...
1. **Type Assertions**: Added `as any` to OpenAI json_schema in recipes.ts,
   mealplan.ts, grocery.ts, nutrition.ts
...
4. **Function Signatures**: Fixed logStructuredError calls to include
   fallbackUsed parameter
