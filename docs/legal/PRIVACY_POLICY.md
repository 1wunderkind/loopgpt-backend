...
- **Order Information:** Delivery addresses, order history, payment information
...
1. **Provide Services**
   ...
   - Track nutrition and health goals
...
4. Transaction Data (orders, purchases)
5. Technical Data (IP address, browser)
6. Profile Data (preferences, interests)
7. Usage Data (interaction with service)
8. Marketing Data (communication preferences)
...
5. **Legitimate Interests:** Our legitimate business interests
