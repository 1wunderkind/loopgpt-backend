...
- [ ] **Environment:** Any new environment variables are added to `_shared/env.ts` and documented in `docs/deploy.md`.
- [ ] **Backward Compatibility:** Changes do not break existing clients or contracts.
- [ ] **Error Handling:** New code uses `ErrorHandler` and standard `ErrorCategory`.
