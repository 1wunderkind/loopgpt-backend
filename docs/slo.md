...
*   **Availability:** Percentage of requests returning non-5xx errors (excluding 503 during maintenance).
...
*   **Red:** Targets breached.
    *   *Action:* Enable **Degraded Mode** (disable retries) or **Safe Mode** (disable ordering).
