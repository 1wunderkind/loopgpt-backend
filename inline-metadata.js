...
const importStart = mcpServer.indexOf(
...
const afterImport = mcpServer.substring(
  importEnd + '} from "./metadata_bundled.ts";'.length,
);
...
console.log(
  "📊 New file size:",
  (fs.statSync(mcpServerFile).size / 1024).toFixed(2),
  "KB",
);
