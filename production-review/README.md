...
This directory contains all documentation required for production readiness
review:
...
Open `manifest.json` and `TOOL_CATALOG.md` side-by-side to understand all 28
tools.

### Step 3: Understand User Flows

Read `CONVERSATION_FLOW.md` to see how tools work together in real
conversations.
