...
export function getCorsHeaders(
  ...
  console.log(`[CORS] Request Origin: ${requestOrigin}, Allowed: ${allowedOrigins.includes(requestOrigin || "")}`);
  ...
  return {
    ...
    "Access-Control-Allow-Headers":
      "authorization, x-client-info, apikey, content-type, x-request-id, baggage, sentry-trace",
