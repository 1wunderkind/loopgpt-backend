...
export const MCP_MANIFEST = {
  ...
  tools: [
    ...
    // ========================================================================
    {
      ...
      description:
        "Generate creative recipes from available ingredients with dietary preferences",
      inputSchema: {
        type: "object",
        properties: {
          version: {
          ...
          dietaryTags: {
            ...
            items: { type: "string" },
            description:
              "Dietary requirements (e.g., vegan, keto, gluten-free)",
          },
          excludeIngredients: {
            type: "array",
            items: { type: "string" },
...

    {
      ...
      description:
        "Generate recipes with automatic nutrition analysis (composite tool - faster than calling both separately)",
      inputSchema: {
        type: "object",
        properties: {
          version: {
...

    {
      ...
      description:
        "Analyze nutritional content of recipes with calorie and macro estimates",
      inputSchema: {
        type: "object",
        properties: {
          version: {
...

    {
      ...
      description:
        "Generate structured meal plans based on goals and dietary preferences",
      inputSchema: {
        type: "object",
        properties: {
          version: {
...

    {
      ...
      description:
        "Generate meal plan with automatic grocery list (composite tool - faster than calling both separately)",
      inputSchema: {
        type: "object",
        properties: {
          version: {
...

    {
      name: "grocery.list",
      description:
        "Generate organized shopping list from recipes or meal plans",
      inputSchema: {
        type: "object",
        properties: {
          version: {
...

    {
      name: "usage.stats",
      description:
        "Get usage statistics and rate limit information for current user",
      inputSchema: {
        type: "object",
        properties: {
          userId: {
