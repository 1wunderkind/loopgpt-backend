  ...
  breakfast: [
    {
      name: "Oatmeal Bowl",
      base: "oatmeal",
      additions: ["banana", "almonds", "honey"],
    },
    {
      name: "Scrambled Eggs",
      base: "eggs",
      additions: ["spinach", "cheese", "toast"],
    },
    {
      name: "Greek Yogurt Parfait",
      base: "yogurt",
      additions: ["berries", "granola", "honey"],
    },
    {
      name: "Avocado Toast",
      base: "bread",
      additions: ["avocado", "eggs", "tomato"],
    },
  ],
  lunch: [
    {
      name: "Chicken Salad",
      base: "chicken breast",
      additions: ["lettuce", "tomato", "olive oil"],
    },
    {
      name: "Tuna Sandwich",
      base: "tuna",
      additions: ["bread", "lettuce", "mayo"],
    },
    {
      name: "Quinoa Bowl",
      base: "quinoa",
      additions: ["chickpeas", "vegetables", "tahini"],
    },
    {
      name: "Turkey Wrap",
      base: "turkey",
      additions: ["tortilla", "lettuce", "cheese"],
    },
  ],
  dinner: [
    {
      name: "Grilled Salmon",
      base: "salmon",
      additions: ["broccoli", "brown rice", "lemon"],
    },
    {
      name: "Chicken Stir-Fry",
      base: "chicken breast",
      additions: ["vegetables", "rice", "soy sauce"],
    },
    {
      name: "Beef Tacos",
      base: "ground beef",
      additions: ["tortilla", "lettuce", "cheese", "salsa"],
    },
    {
      name: "Pasta Primavera",
      base: "pasta",
      additions: ["vegetables", "olive oil", "parmesan"],
    },
  ],
  snack: [
    {
      ...
      base: "apple",
      additions: ["peanut butter"],
    },
    {
      name: "Protein Shake",
      base: "protein powder",
      additions: ["banana", "milk", "oats"],
    },
    {
      name: "Trail Mix",
      base: "almonds",
      additions: ["walnuts", "raisins", "dark chocolate"],
    },
    {
      name: "Hummus & Veggies",
      base: "chickpeas",
      additions: ["carrots", "celery", "olive oil"],
    },
  ],
};
  ...
  try {
    ...
    if (!user_id || !meal_type) {
      return new Response(
        JSON.stringify({
          success: false,
          error: "Missing user_id or meal_type",
        }),
    ...
    const templates =
      MEAL_TEMPLATES[meal_type as keyof typeof MEAL_TEMPLATES] ||
