...
const TOOL_CATEGORIES = {
  "User Profile": [
    {
      ...
      description: "Set weight loss or gain goal",
    },
    { name: "user_set_calorie_goal", description: "Set daily calorie target" },
    {
      name: "user_set_preferences",
      description: "Set dietary preferences and restrictions",
    },
  ],
  "Meal Planning": [
    {
    ...
    },
    {
      ...
      description: "Retrieve current active meal plan",
    },
  ...
  "Nutrition": [
    {
      ...
      description: "Analyze nutrition for any food",
    },
    { name: "nutrition_get_macros", description: "Get macros for ingredients" },
  ],
  "Commerce": [
    {
      name: "loopgpt_route_order",
      description: "Route order to best provider",
    },
  ...
  "Delivery": [
    {
      name: "delivery_search_restaurants",
  ...
  "Loop Intelligence": [
    {
      name: "loop_predict_outcome",
      description: "Predict weight change outcome",
    },
    {
      name: "loop_adjust_calories",
      description: "Adjust calories based on progress",
    },
  ],
  "System": [
    ...
    return new Response(
      JSON.stringify({
        ...
        examples: [
          ...
          {
            query: "How many calories in chicken?",
            tool: "nutrition_analyze_food",
          },
