...
import { DegradationManager, DegradationMode } from "../supabase/functions/_shared/governance/DegradationManager.ts";
...
class MockLogger extends Logger {
  ...
  override warn(msg: string, ctx?: any) { this.logs.push({ level: 'WARN', msg, ctx }); }
}
